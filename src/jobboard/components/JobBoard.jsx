    ...
    <div className="flex-1 min-h-0 overflow-x-auto">
      <div className="flex h-full min-w-[900px] md:min-w-0">
        {STAGES.map((stage) => {
          ...
          return (
            <div key={stage} className="flex-1 border-r border-line last:border-r-0 flex flex-col min-h-0">
              ...
              <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2.5">
                {stageJobs.map((job) => {
                  ...
                  return (
                    ...
                    >
                      <p className="font-medium text-sm text-charcoal leading-snug mb-1.5">{job.title}</p>
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-line/70">
                        <span className="font-mono text-xs font-medium text-charcoal flex items-center">
                          <IndianRupee size={11} className="inline" />{total.toLocaleString('en-IN')}
                        </span>
                        {job.photos > 0 && (
