...
export const TRADES = {
  ...
  hvac: {
    ...
    jobLabel: 'Job',
    jobUnit: 'unit',
    materialCategories: ['Refrigerant', 'Filters', 'Copper piping', 'Compressor parts', 'Insulation'],
    sampleJobs: [
...
export const TRADE_ORDER = ['electrician', 'plumber', 'mechanic', 'carpenter', 'welder', 'hvac', 'painter']
